...
type TransmitterClient interface {
	Transmit(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (Transmitter_TransmitClient, error)
}
...
func (c *transmitterClient) Transmit(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (Transmitter_TransmitClient, error) {
...
func (x *transmitterTransmitClient) Recv() (*DataResponse, error) {
	m := new(DataResponse)
...
type TransmitterServer interface {
	Transmit(*DataRequest, Transmitter_TransmitServer) error
...
func (UnimplementedTransmitterServer) Transmit(*DataRequest, Transmitter_TransmitServer) error {
...
func (x *transmitterTransmitServer) Send(m *DataResponse) error {
...
var Transmitter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/transmitter.proto",
}
